...
const VERTEX_DESCRIPTION = @import("../geometry/geometry.zig").VERTEX_DESCRIPTION;
const VERTEX_ATTR_DESCRIPTION = @import("../geometry/geometry.zig").VERTEX_ATTR_DESCRIPTION;
...
pub const Material = struct {
    ...
    pub fn build(self: *Material, engine: *Engine, vertex_code: []align(@alignOf(u32)) const u8, fragment_code: []align(@alignOf(u32)) const u8) !void {
